...
In this case, The *vujade-eks* is used as CMK key name.
```bash
...
```
```bash
    export MASTER_ARN=arn:aws:kms:ap-northeast-2:123456789123:key/a0b1234c-de5f-6789-g01h-2i34567j890k1
```
...
In this case, the CMK key ID is *a0b1234c-de5f-6789-g01h-2i34567j890k1*.
```bash
1 $ aws kms list-aliases --key-id a0b1234c-de5f-6789-g01h-2i34567j890k1
```
```bash
    {
        "Aliases": [
            {
                ...
                "TargetKeyId": "a0b1234c-de5f-6789-g01h-2i34567j890k1"
            }
        ]
    }
```
