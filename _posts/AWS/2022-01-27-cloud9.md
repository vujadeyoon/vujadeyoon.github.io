...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_1_a.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_1_b.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_2_a.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_2_b.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_2_c.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
You can easily install utilities for developing the Amazon EKS on the AWS cloud9 by executing [bash_install_utils_eks.sh](#bash_install_utils_eks.sh).
...
You can import the created SSH key as below. Please note that you should replace the *\<KEY_NAME\>* with the name that you want.
You can get more information [AWS CLI Command Reference - import-key-pair](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/import-key-pair.html)
in details. In this case, The *\<KEY_NAME\>* is used as vujade-eks.
```bash
1 $ aws ec2 import-key-pair --key-name <KEY_NAME> --public-key-material file://~/.ssh/id_rsa.pub
```
```bash
    {
        "KeyName": "<KEY_NAME>",
...
You can crate the CMK as below. Please note that you should replace the *\<KEY_NAME\>* with the name that you want.
In this case, The *\<KEY_NAME\>* is used as vujade-eks.
```bash
1 $ aws kms create-alias --alias-name alias/<KEY_NAME> --target-key-id $(aws kms create-key --query KeyMetadata.Arn --output text)
2 $ export MASTER_ARN=$(aws kms describe-key --key-id alias/<KEY_NAME> --query KeyMetadata.Arn --output text)
3 $ echo "export MASTER_ARN=${MASTER_ARN}" | tee -a ~/.bash_profile
```
```bash
    export MASTER_ARN=arn:aws:kms:ap-northeast-2:111757828280:key/<CMK_KEY_ID>
```
2. How to check the created CMK <br />
You can check the created CMK by executing below command. You can get *\<CMK_KEY_ID\>* from the [Section 8-1. How to create the CMK](#aws_cmk_create). 
```bash
1 $ aws kms list-aliases --key-id <CMK_KEY_ID>
```
```bash
    {
        "Aliases": [
            {
                "AliasArn": "arn:aws:kms:ap-northeast-2:111757828280:alias/<KEY_NAME>", 
                "CreationDate": 1642430327.096, 
                "AliasName": "alias/<KEY_NAME>", 
                "LastUpdatedDate": 1642430327.096, 
                "TargetKeyId": "<CMK_KEY_ID>"
            }
        ]
    }
```
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_5_a.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/blog/AWS/3_Cloud9/fig_5_b.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
