...
The AWS explains that the AWS Identity and Access Management (IAM) is a web service that helps you securely control access
to AWS resources. You use IAM to control who is authenticated (signed in) and authorized (has permissions) to use resources [1].
You can check the IAM in details on the [What is IAM?](https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html) [1].
...
1. <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html" title="What is IAM?"> What is IAM?</a>
