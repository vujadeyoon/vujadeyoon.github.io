...
## Table of contents
  ...
  9.  [How to set up a NAT](#nat)
  10. [How to set up a route table for the NAT](#route_table_nat)
  11. [Reference](#ref)
...
table for the NAT is addressed in the [Section 10. How to set up a route table for the NAT](#route_table_nat).
...
You should allocate an elastic IP address that is required when creating a NAT in the [Section 10. How to set up a route table for the NAT](#route_table_nat).
...
## 9. How to set up a NAT <a name="nat"></a>

You can easily set up a NAT as shown in Fig. 6. I recommend that you should set a subnet and an elastic IP allocation ID to the created resources.
...
<div class="caption">
    Fig. 6. How to set up a NAT.
</div>

<hr>

## 10. How to set up a route table for the NAT <a name="route_table_nat"></a>

A route table for the NAT has been already created. Thus, you can first find the created route table for the NAT with
...
<div class="caption">
    Fig. 7. How to set up a route table for the NAT.
</div>
