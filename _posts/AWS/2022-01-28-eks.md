...
## Table of contents
  ...
  8. [How to install the AWS load balancer controller](#aws_lbc)
...
## 8. How to install the AWS load balancer controller <a name="aws_lbc"></a>
...
## 16. How to fix error <a name="fix_error"></a>
